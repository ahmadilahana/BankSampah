...
<head>
    ...
    <title>BankSampahKu - Reset Passowrd</title>
                        ...
                        <div class="p-5">
                            ...
                            @if ($errors->has('token'))
                                ...
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong>Warning!</strong> {{ $errors->first('token') }}
                                ...
                                <div class="form-group">
                                    <input type="password" name="new_password" class="form-control form-control-user" id="exampleInputEmail"
                                        ...
                                        @if ($errors->has('new_password'))
                                            <small id="emailHelp" class="form-text text-danger">{{ $errors->first('new_password') }}</small>
                                        @endif
                                </div>
                                <div class="form-group">
                                    <input type="password" name="c_password" class="form-control form-control-user" id="exampleInputEmail"
                                        aria-describedby="emailHelp" placeholder="Confirmation Password">
