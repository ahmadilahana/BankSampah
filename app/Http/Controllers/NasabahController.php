...
class NasabahController extends Controller
{
    public function get_user()
    {
        ...
        return View('page.nasabah', ['users'=>$user]);
    }
    ...
    public function add_user(Request $request)
    {
        ...
        return redirect('/user/nasabah')->with("success", "Nasabah berhasil ditambahkan");
    }
    ...
    {
        $user = User::find($id);
        return view('form.editnasabah', ['user' => $user]);
    }
    ...
    public function update_user(Request $request, $id)
    {
        ...
        return redirect('/user/nasabah')->with("success", "Nasabah berhasil diubah");
    }
}
