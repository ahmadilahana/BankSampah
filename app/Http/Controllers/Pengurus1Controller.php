...
class Pengurus1Controller extends Controller
{
    ...
    {
        $user = User::where('role', 'Pengurus1')->get();
        return View('page.pengurus1', ['users'=>$user]);
    }
    public function add_user(Request $request)
    {
        ...
        return redirect('/user/pengurus1')->with("success", "Pengurus 1 berhasil ditambahkan");
    }

    public function delete_user($id)
    {
        User::destroy($id);
        return redirect()->back()->with("success", "Pengurus 1 berhasil dihapus");
    }

    public function edit_user($id)
    {
        $user = User::find($id);
        return view('form.editpengurus1', ['user' => $user]);
    }
    ...
    public function update_user(Request $request, $id)
    {
        ...
        return redirect('/user/pengurus1')->with("success", "Pengurus 1 berhasil diubah");
    }
}
