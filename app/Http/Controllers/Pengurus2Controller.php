...
class Pengurus2Controller extends Controller
{
    ...
    {
        $user = User::where('role', 'Pengurus2')->get();
        return View('page.pengurus2', ['users'=>$user]);
    }
    public function add_user(Request $request)
    {
        ...
        return redirect('/user/pengurus2')->with("success", "Pengurus 2 berhasil ditambahkan");
    }

    public function delete_user($id)
    {
        User::destroy($id);
        return redirect()->back()->with("success", "Pengurus 2 berhasil dihapus");
    }

    public function edit_user($id)
    {
        $user = User::find($id);
        return view('form.editpengurus2', ['user' => $user]);
    }
    ...
    public function update_user(Request $request, $id)
    {
        ...
        return redirect('/user/pengurus2')->with("success", "Pengurus 2 berhasil diubah");
    }
}
